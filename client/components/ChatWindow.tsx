...
export const ChatWindow: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-[#E7EBF3]">
      {/* Header */}
      <header className="bg-white px-4 py-3 border-b border-slate-200 flex items-center justify-between sticky top-0 z-10 md:px-6">
      ...
      {/* Messages */}
      <div className="flex-1 overflow-y-auto p-2 md:p-6 space-y-3">
              ...
              <ContextMenu>
                <ContextMenuTrigger asChild>
                  ...
                  >
                    ...
                    <div
                      className={`text-[10px] md:text-xs mt-1 flex items-center justify-end gap-1 ${isMe ? "text-blue-100" : "text-slate-400"}`}
                    >
                      <span>{time}</span>
                      {isMe && (
                        <span>
      ...
      {/* Input */}
      <div className="bg-white p-3 border-t border-slate-200 md:p-4">
        <form
