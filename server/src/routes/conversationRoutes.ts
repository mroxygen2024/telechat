...
import { conversationIdParamSchema, createConversationSchema } from '../validators/conversationValidators.js'
...
conversationRoutes.post('/', requireAuth, validate(createConversationSchema), createConversation)
